...
When you have direnv installed and you enter the directory containing the `.envrc` file, the lines
above get executed.

I recommend the [VS Code Direnv
Extension](https://marketplace.visualstudio.com/items?itemName=mkhl.direnv) if you use VS Code. It
enables your custom environment for tasks started by VS Code (for example, AI coding agents).
...
Direnv works well together with Nix. I describe that here: [guettli/switching-to-nix: Switching to
Nix](https://github.com/guettli/switching-to-nix)
